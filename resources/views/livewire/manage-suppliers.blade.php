            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    <div class="w-full md:w-1/3">
                        <x-input wire:model.live.debounce.300ms="search" type="search" placeholder="Search suppliers..." class="w-full" />
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th wire:click="sortBy('contact_person')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                                    Contact Person
                                </th>
                            ...
                            @forelse($suppliers as $supplier)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <button wire:click="delete({{ $supplier->id }})" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this supplier?')">Delete</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
