<aside x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        @if(auth()->user()->role === 'admin')
                            <x-nav-link href="{{ route('payments.dashboard') }}" :active="request()->routeIs('payments.dashboard')">
                                {{ __('Payments') }}
                            </x-nav-link>
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'admin')
                <x-responsive-nav-link href="{{ route('payments.dashboard') }}" :active="request()->routeIs('payments.dashboard')">
                    {{ __('Payments') }}
                </x-responsive-nav-link>
